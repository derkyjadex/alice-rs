...
impl<W: Write> Writer<W> {
    ...
    fn write_tag(&mut self, value: Tag) -> io::Result<()> {
        try!(self.output.write_all(&[0xee]));
    ...
    fn write_bool(&mut self, value: bool) -> io::Result<()> {
        if value {
            self.output.write_all(&[0x00, 0x01])
        } else {
    ...
    fn write_int(&mut self, value: i32) -> io::Result<()> {
        try!(self.output.write_all(&[0x01]));
        self.write_sint(value as i64)
    }

    fn write_double(&mut self, value: f64) -> io::Result<()> {
        try!(self.output.write_all(&[0x02]));
        self.output.write_f64::<LittleEndian>(value)
            .map_err(map_to_io)
    }

    fn write_vec2(&mut self, value: Vec2) -> io::Result<()> {
        try!(self.output.write_all(&[0x03]));
        try!(self.output.write_f64::<LittleEndian>(value.0)
            .map_err(map_to_io));
        self.output.write_f64::<LittleEndian>(value.1)
            .map_err(map_to_io)
    }

    fn write_vec3(&mut self, value: Vec3) -> io::Result<()> {
        try!(self.output.write_all(&[0x04]));
        try!(self.output.write_f64::<LittleEndian>(value.0)
            .map_err(map_to_io));
        try!(self.output.write_f64::<LittleEndian>(value.1)
            .map_err(map_to_io));
        self.output.write_f64::<LittleEndian>(value.2)
            .map_err(map_to_io)
    }

    fn write_vec4(&mut self, value: Vec4) -> io::Result<()> {
        try!(self.output.write_all(&[0x05]));
        try!(self.output.write_f64::<LittleEndian>(value.0)
            .map_err(map_to_io));
        try!(self.output.write_f64::<LittleEndian>(value.1)
            .map_err(map_to_io));
        try!(self.output.write_f64::<LittleEndian>(value.2)
            .map_err(map_to_io));
        self.output.write_f64::<LittleEndian>(value.3)
            .map_err(map_to_io)
    }

    fn write_box2(&mut self, value: Box2) -> io::Result<()> {
        try!(self.output.write_all(&[0x06]));
        try!(self.output.write_f64::<LittleEndian>((value.0).0)
            .map_err(map_to_io));
        try!(self.output.write_f64::<LittleEndian>((value.0).1)
            .map_err(map_to_io));
        try!(self.output.write_f64::<LittleEndian>((value.1).0)
            .map_err(map_to_io));
        self.output.write_f64::<LittleEndian>((value.1).1)
            .map_err(map_to_io)
    }

    fn write_string(&mut self, value: &Box<str>) -> io::Result<()> {
        try!(self.output.write_all(&[0x07]));
    ...
    fn write_blob(&mut self, value: &Box<[u8]>) -> io::Result<()> {
        try!(self.output.write_all(&[0x08]));
